...
![image-20251031035102010](image-20251031035102010.png)
![image-20251031035132915](image-20251031035132915.png)
...
![image-20251031035433240](image-20251031035433240.png)
![image-20251031035647577](image-20251031035647577.png)
...
![image-20251031035719147](image-20251031035719147.png)
![image-20251031035752576](image-20251031035752576.png)

## 注册新域名
回到客户区域后，点击左侧导航栏的“订购”选项，再点击“选择产品”下的“域名注册和转让”。

![image-20251031035831673](image-20251031035831673.png)

注册新域名选项里，有“filegear-sg.me”和“ggff.net”两个，一般选短的那个，好输入，两个都是可以使用 Cloudflare 的。输入自己想要的域名前缀，点下一步。

![image-20251031035913444](image-20251031035913444.png)

到了结账页面，这一步很关键，点一下蓝色的“有优惠券代码？”，输入“newuser”。应用后可能会弹出提示框，点确定就行，总计显示零元就对了，然后点击去结算。

![image-20251031040000969](image-20251031040000969.png)
![image-20251031040049985](image-20251031040049985.png)

需要等几分钟让订单处理，处理完后订单状态会变成“已启用”，接下来我们要把它托管到Cloudflare。

![image-20251031042815115](image-20251031042815115.png)

## 将域名托管到Cloudflare
把域名添加到Cloudflare，复制Cloudflare分配的两个NS服务器。

![image-20251031044532345](image-20251031044532345.png)

回到订单页，点击下面的“名称服务器”，把原来的4个NS服务器都删掉，替换成Cloudflare分配的NS，最后点击更新。过几分钟或几个小时后，域名在Cloudflare下激活，就配置完成了。

![image-20251031044729245](image-20251031044729245.png)
![image-20251031050854499](image-20251031050854499.png)
